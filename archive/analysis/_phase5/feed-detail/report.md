...
- 404 GET http://127.0.0.1:4173/api/posts/feed-1
- 500 POST http://127.0.0.1:4173/api/posts/feed-1/view
- 401 GET http://127.0.0.1:4173/api/notifications/unread-count
- 401 GET http://127.0.0.1:4173/api/notifications/unread-count

### Screenshots
- Full page: `feed-detail-full.png`
- `feed-detail-scroll00.png`
- `feed-detail-scroll01.png`