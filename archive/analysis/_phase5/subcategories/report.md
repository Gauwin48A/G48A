...
- **Scroll height:** 5201px (NaN screens)
- **Score:** **9.9/10**
...
- `<a>` 49×32 — "Home" — `transition-colors hover:text-foreground inline-flex`
...
### Screenshots
- Full page: `subcategories-full.png`
- `subcategories-scroll00.png`
- `subcategories-scroll01.png`
- `subcategories-scroll02.png`
- `subcategories-scroll03.png`
- `subcategories-scroll04.png`
- `subcategories-scroll05.png`
- `subcategories-scroll06.png`
- `subcategories-scroll07.png`