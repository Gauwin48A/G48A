# Audit — centre-listings

- **Route:** `/centre/ch-1/listings`
- **Logged in:** true
- **Viewport:** undefined×undefined
- **Scroll height:** 2748px (NaN screens)
- **Score:** **10/10**
...
### Screenshots
- Full page: `centre-listings-full.png`
- `centre-listings-scroll00.png`
- `centre-listings-scroll01.png`
- `centre-listings-scroll02.png`
- `centre-listings-scroll03.png`
- `centre-listings-scroll04.png`