...
- **Scroll height:** 1490px (NaN screens)
- **Score:** **9.6/10**
...
- `<button>` 32×36 — "" — `p-2 text-gray-400 hover:text-green-600`
- `<button>` 32×36 — "" — `p-2 text-gray-400 hover:text-red-500`
- `<button>` 32×36 — "" — `p-2 text-gray-400 hover:text-green-600`
- `<button>` 32×36 — "" — `p-2 text-gray-400 hover:text-red-500`
...
### Screenshots
- Full page: `my-feed-full.png`
- `my-feed-scroll00.png`
- `my-feed-scroll01.png`
- `my-feed-scroll02.png`