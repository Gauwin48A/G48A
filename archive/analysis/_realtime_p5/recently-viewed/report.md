# Audit — recently-viewed

- **Route:** `/recently-viewed`
- **Logged in:** true
- **Viewport:** undefined×undefined
- **Scroll height:** 1088px (NaN screens)
- **Score:** **9.7/10**
...
- `<button>` 28×36 — "" — `relative z-10 flex`
- `<button>` 28×36 — "" — `relative z-10 flex`
- `<button>` 32×36 — "" — `absolute bottom-3 right-3`
...
### Screenshots
- Full page: `recently-viewed-full.png`
- `recently-viewed-scroll00.png`
- `recently-viewed-scroll01.png`