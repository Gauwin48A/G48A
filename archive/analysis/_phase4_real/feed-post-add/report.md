...
- `<span>` 11px — "Feed" — `mhub-bottom-nav-label is-active`
...
### Screenshots
- Full page: `feed-post-add-full.png`
- `feed-post-add-scroll00.png`
- `feed-post-add-scroll01.png`