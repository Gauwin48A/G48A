...
- **Scroll height:** 922px (NaN screens)
- **Score:** **9.4/10**
...
### Tiny fonts (<12px)
- `<div>` 11px — "Bachupally · Good (GPS) ±50m
×" — `location-accuracy-badge-wrap`
- `<button>` 11px — "Bachupally · Good (GPS) ±50m" — `location-accuracy-badge`
- `<span>` 11px — "Bachupally · Good (GPS) ±50m" — ``
- `<button>` 11px — "×" — `location-accuracy-badge-close`
