...
- **Scroll height:** 941px (NaN screens)
- **Score:** **8.7/10**
...
- `<div>` 11px — "Bachupally · Cached (Network) ±50m · 0s " — `location-accuracy-badge-wrap`
- `<button>` 11px — "Bachupally · Cached (Network) ±50m · 0s " — `location-accuracy-badge`
- `<span>` 11px — "Bachupally · Cached (Network) ±50m · 0s " — ``
...
### Screenshots
- Full page: `my-posts-full.png`
- `my-posts-scroll00.png`
- `my-posts-scroll01.png`