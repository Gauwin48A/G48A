...
- **Scroll height:** 3040px (NaN screens)
- **Score:** **9.4/10**
...
- `<button>` 32×36 — "" — `absolute top-2 right-2`
- `<button>` 32×36 — "" — `absolute top-2 right-2`
- `<button>` 32×36 — "" — `absolute top-2 right-2`
- `<button>` 32×36 — "" — `absolute top-2 right-2`
- `<button>` 32×36 — "" — `absolute top-2 right-2`
...
### Screenshots
- Full page: `buyer-view-full.png`
- `buyer-view-scroll00.png`
- `buyer-view-scroll01.png`
- `buyer-view-scroll02.png`
- `buyer-view-scroll03.png`
- `buyer-view-scroll04.png`