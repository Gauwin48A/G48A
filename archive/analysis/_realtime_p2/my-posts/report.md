...
- **Scroll height:** 1563px (NaN screens)
- **Score:** **9.6/10**
...
- `<button>` 72×32 — "All2" — `rewards-tab-btn flex-1 min-w-0`
- `<button>` 80×32 — "Active0" — `rewards-tab-btn flex-1 min-w-0`
- `<button>` 72×32 — "Sold0" — `rewards-tab-btn flex-1 min-w-0`
- `<button>` 72×32 — "Bought0" — `rewards-tab-btn flex-1 min-w-0`
