# Audit — channel-detail

- **Route:** `/channels/ch-1`
- **Logged in:** false
- **Viewport:** undefined×undefined
- **Scroll height:** 928px (NaN screens)
- **Score:** **9/10**
...
### Network failures
- 401 GET http://127.0.0.1:4173/api/channels/ch-1
- 401 POST http://127.0.0.1:4173/api/auth/refresh-token

### Screenshots
- Full page: `channel-detail-full.png`
- `channel-detail-scroll00.png`
- `channel-detail-scroll01.png`