...
const RewardsPage = () => {
  ...
  const firstRewardCompletedCount = onboardingSteps.filter((t) => t.done).length;
  const firstRewardProgressPercent = onboardingSteps.length
    ? Math.round((firstRewardCompletedCount / onboardingSteps.length) * 100)
    : 0;
  const nextOnboardingStep =
    onboardingSteps.find((t) => !t.done) || onboardingSteps[onboardingSteps.length - 1];
  const referralPrimaryCta = milestoneEligible
    ? tr("claim_reward", "Claim reward")
    : tr("share_referral_link_now", "Share referral link now");
  const referralStatusLabel = milestoneEligible
    ? tr("reward_ready", "Reward ready")
    : milestoneClaimed
      ? tr("reward_claimed", "Reward claimed")
      : qualifiedReferrals > 0
        ? tr("qualified_referrals", "Qualified referrals")
        : totalReferrals > 0
          ? tr("invite_sent", "Invites sent")
          : tr("first_reward", "First reward");
  const referralStatusHint = milestoneEligible
    ? tr(
        "claim_referral_reward_hint",
        "You have completed the referral milestone and can claim it now.",
      )
    : milestoneClaimed
      ? tr(
          "referral_reward_claimed_hint",
          "Your latest referral milestone has already been claimed.",
        )
      : qualifiedReferrals > 0
        ? tr(
            "qualified_referral_hint",
            "Qualified referrals are already counting toward your next milestone.",
          )
        : totalReferrals > 0
          ? tr(
              "pending_referral_hint",
              "Your invites are out. The next unlock happens after a verified trade.",
            )
          : tr(
              "first_referral_hint",
              "Start here to unlock your first reward faster.",
            );
  const referralMessagePreview = tr(
    "referral_message_preview",
    "Join MHub with my referral code {{code}} and unlock bonus coins after your first successful trade.",
    { code: r?.referralCode || "MHUB" },
  );
  const tabButtonClass = (tab) =>
    "rewards-tab-btn flex-1 min-w-[120px] rounded-xl border px-3 py-2.5 text-xs sm:text-sm font-bold transition-all duration-200 " +
    (activeTab === tab
      ? "active border-indigo-300/60 bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md shadow-indigo-200/50 dark:shadow-indigo-900/40 scale-[1.02]"
      : "border-transparent text-slate-500 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-700/50 hover:text-slate-800 dark:hover:text-white");
  return React.createElement(
    "div",
    {
      className:
    ...
    React.createElement(
      ...
      React.createElement("div", {
        className:
          "absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 opacity-90",
      }),
      React.createElement("div", {
          ...
          "div",
        {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              coinDelta?.amount
                ? React.createElement(
                    "div",
                    {
                      className: `delta-badge pointer-events-none absolute right-2 top-2 rounded-full px-2.5 py-1 text-xs font-black shadow-lg ${
                        coinDelta.amount > 0
              ...
              React.createElement(
                ...
                React.createElement(
                  "span",
                  { className: "coin-icon-float text-xl select-none", "aria-hidden": "true" },
                  "\uD83E\uDE99"
                ),
              ),
              React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "p",
                { className: "text-xs font-semibold text-slate-500 dark:text-slate-300 mb-1" },
                tr("referral_funnel", "Referral funnel"),
              ),
              React.createElement(
                "div",
                { className: "space-y-3" },
                React.createElement(
                  ...
                  {
                    className:
                      "rounded-xl border border-slate-200 bg-slate-50/80 dark:border-slate-700 dark:bg-slate-900/40 p-3",
                  },
                  React.createElement(
                    "div",
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        "mt-3 h-2 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden",
                    },
                    React.createElement("div", {
                      className:
                        "h-full bg-gradient-to-r from-indigo-500 to-sky-500 rounded-full transition-[width] duration-700 ease-out",
                      style: { width: `${referralProgressPercent}%` },
                    }),
                  ),
                  React.createElement(
                    ...
                    {
                      className:
                        "mt-2 flex items-center justify-between text-xs text-slate-500 dark:text-slate-300",
                    },
                    React.createElement(
                      "span",
                      null,
                ...
                React.createElement(
                  ...
                  {
                    className:
                      "referral-code-box rounded-xl p-3",
                  },
                  React.createElement(
                    "p",
                    {
                    ...
                    tr("message_preview", "Message preview"),
                  ),
                  React.createElement(
                    "p",
                    {
                      className:
                        "mt-1 text-sm text-indigo-900 dark:text-indigo-100",
                    },
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        "mt-2 text-[11px] text-indigo-700/80 dark:text-indigo-200/80 break-all",
                    },
                    referralShareDisplay || tr("referral_link_pending", "Referral link will appear here once ready."),
                  ),
                ),
                React.createElement(
                  Button,
                  {
                    type: "button",
                    size: "sm",
                    disabled: shareDisabled && !milestoneEligible,
                    onClick: milestoneEligible ? handleClaimMilestone : shareReferral,
                    className:
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "mb-4 grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)]",
          },
          React.createElement(
            Card,
            {
              className:
                "bg-white dark:bg-gray-800 border border-slate-200/60 dark:border-gray-700/60 shadow-xl rounded-2xl page-fade-in page-fade-in-delay-1",
            },
            React.createElement(
              CardContent,
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        "text-xs font-semibold uppercase tracking-wide text-indigo-600 dark:text-indigo-300",
                    },
                    tr("first_reward_plan", "First reward plan"),
                  ),
                  React.createElement(
                    "h2",
                    {
                      className:
                        "mt-1 text-lg sm:text-xl font-bold text-slate-900 dark:text-white",
                    },
                    nextOnboardingStep?.label ||
                      tr("complete_your_first_reward", "Complete your first reward"),
                  ),
                  React.createElement(
                    "p",
                    {
                    ...
                    nextOnboardingStep?.hint ||
                      tr(
                        "first_reward_ready_hint",
                        "You have already unlocked the first-reward path. Keep momentum going.",
                      ),
                  ),
                ),
                React.createElement(
                  ...
                  {
                    className:
                      "self-start bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-200",
                  },
                  firstRewardCompletedCount,
                  "/",
                  onboardingSteps.length,
                  " ",
                  tr("steps_complete", "steps complete"),
                ),
              ),
              React.createElement(
                "div",
                {
                  className:
                    "h-2.5 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden",
                },
                React.createElement("div", {
                  className:
                    "h-full bg-gradient-to-r from-indigo-500 to-sky-500 rounded-full transition-[width] duration-700 ease-out",
                  style: { width: `${firstRewardProgressPercent}%` },
                }),
              ),
              React.createElement(
                "div",
                ...
                onboardingSteps.slice(0, 4).map((step) =>
                  React.createElement(
                    "div",
                    {
                      key: step.key,
                      className:
                        "rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-900/30 px-3 py-2",
                    },
                    React.createElement(
                      "div",
                      ...
                      step.done
                        ...
                        : React.createElement(Circle, {
                            className: "mt-0.5 w-4 h-4 text-slate-400",
                          }),
                      React.createElement(
                        "div",
                        null,
          ...
          React.createElement(
            ...
            {
              className:
                "rounded-2xl border border-indigo-100 bg-white/95 p-4 shadow-xl dark:border-indigo-900/40 dark:bg-gray-800/95",
            },
            React.createElement(
              "p",
              {
            ...
            React.createElement(
              ...
              {
                className:
                  "mt-3 h-2.5 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden",
              },
              React.createElement("div", {
                className:
            ...
            React.createElement(
              Button,
              {
                ...
                onClick: () => setActiveTab(nextRewardRemaining > 0 ? "earn" : "redeem"),
              },
              nextRewardRemaining > 0
                ? tr("earn_toward_reward", "Earn toward this reward")
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        "span",
                        { className: "coin-icon-float text-3xl pb-1 select-none" },
                        "\uD83E\uDE99",
                      ),
                    ),
                  ),
