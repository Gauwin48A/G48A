...
function PostDetail() {
  ...
  const z = () => {
    ...
    o = r.seller || {
      name: r.author || tr("verified_seller", "Verified Seller"),
      id: r.user_id || tr("na", "N/A"),
      rating: "4.5",
      verified: !0,
    },
    tierLabel = r?.tier
              ...
              e.createElement(
                ...
                e.createElement(
                  "button",
                  {
                    onClick: H,
                    className:
                      "absolute left-2 top-1/2 -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 p-3 sm:p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity",
                  },
                ...
                e.createElement(
                  "button",
                  {
                    onClick: z,
                    className:
                      "absolute right-2 top-1/2 -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 p-3 sm:p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity",
                  },
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                " ",
                r.category || tr("category", "Category"),
              ),
              e.createElement(
                "span",
                {
                ...
                " ",
                r.condition || tr("condition_good", "Good Condition"),
              ),
              e.createElement(
                "span",
                {
                ...
                " ",
                r.location || tr("location", "Location"),
              ),
            ),
            e.createElement(
              "div",
