...
const SaleUndonePage = () => {
  ...
  const Y = () =>
    ...
    le = async (r) => {
      const categoryQuery = categoryModeCategoryId
        ? `?category_id=${encodeURIComponent(categoryModeCategoryId)}`
        : "";
      const o = [S, re("/posts/undone")].map(
        (endpoint) => `${endpoint}${categoryQuery}`,
      );
      let a = null;
      for (const i of o)
        try {
  ...
  return F
    ? e.createElement(
        ...
        {
          className:
            "min-h-screen bg-gradient-to-br from-emerald-400 via-green-500 to-teal-600 relative overflow-hidden",
        },
        e.createElement(
          "div",
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  {
                    className:
                      "relative w-32 h-32 mx-auto bg-gradient-to-br from-emerald-400 to-green-600 rounded-full flex items-center justify-center shadow-2xl",
                  },
              ...
              e.createElement(
                ...
                {
                  className:
                    "text-4xl font-black bg-gradient-to-r from-emerald-600 to-green-700 bg-clip-text text-transparent mb-4",
                },
                "\uD83D\uDD04 ",
              ...
              e.createElement(
                ...
                {
                  className:
                    "bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl p-6 mb-8 border border-emerald-200",
                },
                e.createElement(
                  "div",
                ...
                { className: "flex flex-col sm:flex-row gap-4 justify-center" },
                  e.createElement(
                    p,
                    {
                      ...
                      onClick: W,
                      className:
                        "border-2 border-emerald-500 text-emerald-600 hover:bg-emerald-50 rounded-xl px-8 py-3 font-semibold",
                    },
                  ...
                  e.createElement(
                    ...
                    {
                      className:
                        "bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 rounded-xl px-8 py-3 font-semibold shadow-lg",
                      onClick: () => L("/my-home"),
                    },
    ...
    : e.createElement(
        ...
        hasCategoryMode &&
          ...
          e.createElement(
            ...
            {
              className:
                "rounded-2xl border border-orange-200 bg-white/90 dark:border-orange-900/40 dark:bg-gray-900/70 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 shadow-sm",
            },
            e.createElement(
              "div",
              null,
            ...
            e.createElement(
              p,
              {
                type: "button",
                variant: "outline",
                className: "border-orange-200 text-orange-700 w-fit",
                        ...
                        hasCategoryMode &&
                          ...
                          e.createElement(
                            p,
                            {
                              ...
                              variant: "outline",
                              className:
                                "mt-4 border-orange-200 text-orange-700",
                              onClick: () => L("/category-mode"),
                            },
                            tr("switch_category", "Switch category"),
                          ),
