...
const SaleDone = () => {
  ...
  if (completedSale) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-green-500 to-teal-600 dark:from-emerald-800 dark:via-green-900 dark:to-teal-900 relative overflow-hidden">
        {/* Celebration blobs */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-white/10 rounded-full blur-3xl animate-pulse" />
          <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-yellow-300/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "0.8s" }} />
          <div className="absolute top-1/3 right-0 w-48 h-48 bg-white/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: "1.4s" }} />
        </div>
          ...
          <Card className="shadow-2xl border-0 rounded-3xl overflow-hidden backdrop-blur-xl bg-white/95 dark:bg-gray-800/95">
            <CardContent className="p-10 text-center">
              ...
              <div className="relative inline-block mb-6">
                ...
                <div className="relative w-28 h-28 mx-auto rounded-full bg-gradient-to-br from-green-400 to-emerald-600 flex items-center justify-center shadow-2xl">
                  <CheckCircle className="w-14 h-14 text-white" />
                </div>
              </div>

              <div className="text-4xl mb-2">🎉</div>
              <h2 className="text-4xl font-black bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent mb-3">
              ...
              <div className="rounded-xl border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 p-4 text-left mb-6">
                ...
                <div className="flex items-center justify-between gap-3">
                  <p className="font-mono text-green-900 dark:text-green-100 break-all text-sm flex-1">
                  ...
                  {completedSale.transactionId && (
                    ...
                    >
                      {copied ? <CheckIcon className="w-4 h-4 text-green-600" /> : <Copy className="w-4 h-4 text-green-600" />}
                    </button>
                  )}
                </div>
              </div>
              ...
              {/* Next steps */}
              <div className="rounded-xl border border-emerald-100 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/20 p-4 text-left mb-8">
