          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {milestones.map((milestone, index) => (
              <div
                ...
                className={`milestone-badge ${milestone.unlocked ? "unlocked" : "locked"} p-4 rounded-2xl text-center relative overflow-hidden ${
                  milestone.unlocked
              ...
              >
                ...
                <div className="badge-icon mb-2 mx-auto">{milestone.icon}</div>
                <p
                ...
                {milestone.unlocked ? (
                  <div className="mt-2 inline-flex items-center gap-1 rounded-full bg-emerald-100 dark:bg-emerald-900/30 px-2 py-0.5">
                    <span className="text-[9px] font-bold text-emerald-700 dark:text-emerald-300 uppercase tracking-wide">
                      {tr("unlocked", "Unlocked")}
                    </span>
                  </div>
                ) : (
                  <div className="mt-2 inline-flex items-center rounded-full bg-slate-200/60 dark:bg-slate-700/40 px-2 py-0.5">
