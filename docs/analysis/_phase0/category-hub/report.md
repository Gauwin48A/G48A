...
- **Scroll height:** 968px (NaN screens)
- **Score:** **9.9/10**
...
- `<button>` 26×36 — "×" — `location-accuracy-badge-close`
...
### Screenshots
- Full page: `category-hub-full.png`
- `category-hub-scroll00.png`
- `category-hub-scroll01.png`