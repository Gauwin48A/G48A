...
**Generated:** 2026-04-22T13:03:22.852Z
**Web source:** `test-screenshots\web-reference-auth-live-auth-20260422-2026-04-22T12-53-47-110Z`
**Android source:** `test-screenshots\android-auth-2026-04-22-12-57-52`
...
| Axis | Score | Rating |
|---|---:|:---|
| Functionality | 6.0/10 | ⚠ Needs Work |
| Features      | 5.7/10 | ⚠ Needs Work |
| UI/UX Design  | 5.1/10 | ⚠ Needs Work |
| **Overall**   | **5.6/10** | **⚠ Needs Work** |

**Pages evaluated:** 48  
**Web screenshots:** 60  
**Android screenshots:** 62
...
- Android: 031_recently-viewed.png
...
**Screenshots:**
- Web: 53_saved-searches.png
- Android: 032_saved-searches.png
...
- Android: 013_forgot-password.png
...
| UI/UX Design  | 2/10 | ❌ Critical Gap |
| **Overall**   | **2/10** | **❌ Critical Gap** |

**Screenshots:**
- Web: ❌ Not found
- Android: 054_analytics.png

**Assessment:**
- ❌ No screenshots captured — cannot evaluate
...
- Android: 060_account_delete.png
...
**Screenshots:**
- Web: 17_add-post.png
- Android: 023_add-post.png

**Assessment:**
- ⚠ Android screenshot missing or blank
- ✅ Web screenshot available — partial evaluation only
- ⚠ Android screenshot is 29KB — likely blank/loading state
...
- Android: 026_tier-selection.png
...
- Android: 037_aadhaar-verify.png
...
**Screenshots:**
- Web: ❌ Not found
- Android: 049_channels_create.png
...
| Axis | Score | Status |
|---|---:|:---|
| Functionality | 1/10 | ❌ Critical Gap |
| Features      | 1/10 | ❌ Critical Gap |
| UI/UX Design  | 1/10 | ❌ Critical Gap |
| **Overall**   | **1/10** | **❌ Critical Gap** |

**Screenshots:**
- Web: ❌ Not found
- Android: 057_privacy-policy.png

**Assessment:**
- ❌ No screenshots captured — cannot evaluate
- ⚠ Android screenshot is 21KB — likely blank/loading state
...
**Screenshots:**
- Web: ❌ Not found
- Android: 059_support-ticket-policy.png
