...
- Rewards: web=`39_rewards.png`, android=`046_rewards.png`, scores=6 / 6 / 5, status=Captured (layout/state divergence)
- Profile: web=`14_profile.png`, android=`041_profile.png`, scores=6 / 6 / 5, status=Captured (layout/state divergence)
