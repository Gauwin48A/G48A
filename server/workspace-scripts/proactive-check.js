...
const checks = [
  {
    ...
    cwd: rootDir,
    args: ['server/workspace-scripts/guard-tracked-deps.js']
  },
  {
    name: 'Workspace footprint guard',
    command: process.execPath,
    cwd: rootDir,
    args: ['server/workspace-scripts/guard-footprint.js']
  },
  {
    name: 'Workspace codebase line budget guard',
    command: process.execPath,
    cwd: rootDir,
    args: ['server/workspace-scripts/line-budget.js', '--mode=guard']
  },
  {
    name: 'Workspace locale validation',
    command: process.execPath,
    cwd: rootDir,
    args: ['server/workspace-scripts/validate-locales.js']
  },
  {
    name: 'Proactive workflow contract gate',
    command: process.execPath,
    cwd: rootDir,
    args: ['server/workspace-scripts/check-proactive-workflow-contract.js']
  },
