...
|---|---|---|---|---|
| 2026-02-28 | Server full suite | `npm test` | PASS | 19 suites, 115 tests, 0 failures, no open-handle warning |
...
| 2026-02-28 | Active-active dependency gate | `npm run failover:active-active:dependency-gate` | PASS | `server/docs/artifacts/active_active_dependency_gate_2026-02-28T05-39-10-441Z.json` (`BLOCKED` with explicit owner/dependency/impact/fallback rows, expected; runtime optimized to sub-second path when replica inputs are missing) |
