...
|---|---|---|---|---|
| 2026-02-28 | Server full suite | `npm test` | PASS | 20 suites, 122 tests, 0 failures, no open-handle warning |
...
| 2026-02-28 | Readiness probe matrix | `npm run readiness:probe-matrix` | PASS | `server/docs/artifacts/readiness_probe_matrix_2026-02-28T05-56-38-414Z.json` |
| 2026-02-28 | Load test (legit+abuse) | `node tests/load/simple_load_runner.js --scenario both` | PASS | `server/tests/load/results/capacity_report_2026-02-28T05-54-30-958Z.json` |
| 2026-02-28 | Load test (full incl auth/write) | `node tests/load/simple_load_runner.js --scenario full` | PASS | `server/tests/load/results/capacity_report_2026-02-28T05-55-55-973Z.json` |
...
| 2026-02-28 | Active-active dependency gate | `npm run failover:active-active:dependency-gate` | PASS | `server/docs/artifacts/active_active_dependency_gate_2026-02-28T05-56-34-192Z.json` (`BLOCKED` with explicit owner/dependency/impact/fallback rows, expected; runtime optimized to sub-second path when replica inputs are missing) |
...
| 2026-02-28 | Active-active execute proof (synthetic probes) | `$env:ACTIVE_ACTIVE_RUN_SAFETY_AUDIT='false'; npm run failover:active-active:synthetic-execute` | PASS | `server/docs/artifacts/active_active_orchestration_2026-02-28T05-56-34-101Z.json` |
