import e, { useEffect as L, useMemo as P, useState as i } from "react";
    ...
    L(() => {
      ...
      return (
        (async () => {
          m(!0), b("");
          try {
            const l = await E.get("/posts/mine", {
              params: {
                userId: s,
                limit: 100,
                page: 1,
            ...
            if (t) return;
            const y = l?.data ?? l,
              w = (Array.isArray(y?.posts) ? y.posts : []).filter(
                (B) => String(B?.ownership || "").toLowerCase() === "bought",
              );
            u(w);
          } catch (l) {
            t ||
              (b(l.message || r("error") || "Failed to load bought posts"),
              u([]));
          } finally {
            t || m(!1);
          }
    ...
    g
      ...
      : p
              ...
              k
                ? e.createElement(
                    ...
                    Array.from({ length: 3 }).map((t, a) =>
                      e.createElement(
                        "div",
                        {
                          key: `bought-skeleton-${a}`,
                          className:
                            "rounded-xl border border-gray-200 dark:border-gray-700 p-4 animate-pulse",
                        },
                        e.createElement("div", {
                          className:
                            "h-5 w-2/3 bg-gray-200 dark:bg-gray-700 rounded mb-2",
                        }),
                        e.createElement("div", {
                          className:
                            "h-4 w-full bg-gray-200 dark:bg-gray-700 rounded mb-2",
                        }),
                        e.createElement("div", {
                          className:
                            "h-4 w-1/3 bg-gray-200 dark:bg-gray-700 rounded",
                        }),
                      ),
                    ),
                  )
                : x
                  ? e.createElement(
                      ...
                      {
                        className:
                          "rounded-xl border border-red-200 bg-red-50 dark:bg-red-950/30 dark:border-red-900 p-4",
                      },
                      e.createElement(
                        "p",
                        {
                  ...
                  : c.length === 0
                    ? e.createElement(
                        ...
                        {
                          className:
                            "rounded-xl border border-blue-200 bg-blue-50 dark:bg-blue-950/30 dark:border-blue-900 p-6 text-center",
                        },
                        e.createElement(
                          "p",
                          {
                        ...
                        c.map((t, a) =>
                          e.createElement(
                            "div",
                            {
                              ...
                              className:
                                "bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 p-4",
                            },
                            e.createElement(
                              "h3",
                              {
        ...
        : e.createElement(
            ...
            {
              className:
                "min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 px-4",
            },
            e.createElement(
              "div",
              ...
              e.createElement(
                ...
                e.createElement(
                  v,
                  {
                    to: "/login",
                    className:
                      "bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold",
                  },
                  r("login") || "Login",
                ),
                e.createElement(
                  v,
                  {
                    to: "/signup",
                    className:
                      "border border-blue-300 text-blue-600 py-3 rounded-xl font-semibold",
                  },
