...
export default function Support() {
  ...
  const getTransactionReasonLabel = useCallback(
    (reason) => {
      ...
      if (!rawReason) {
        return t("support_wallet_activity") || "Wallet activity";
      }
      if (rawReason === "Welcome bonus") {
        return t("support_txn_welcome_bonus") || "Welcome bonus";
      }
      if (rawReason === "Daily reward") {
        return t("support_txn_daily_reward") || "Daily reward";
      }
      ...
      <div className="mx-auto w-full max-w-6xl px-4 pb-24 pt-6 md:px-6 md:pt-8">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-2xl font-bold md:text-3xl">
                {t("support_page_title") || "Medication & Support"}
              </h1>
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1.5 text-sm font-semibold">
              ...
              {t("support_safe_workflow") ||
                "Safe, structured support workflow"}
            </div>
          </div>
        </div>
          ...
          <Card className="border-blue-100 dark:border-gray-700 md:col-span-2">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2 text-lg">
                ...
                {t("support_wallet_title") || "Coins Wallet"}
              </CardTitle>
            </CardHeader>
                  ...
                  <div className="flex flex-col gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-900 dark:bg-amber-950/25 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wide text-amber-700 dark:text-amber-300">
                        {t("support_available_balance") || "Available Balance"}
                      </p>
                    ...
                    >
                      {t("support_claim_daily", { amount: 20 }) ||
                        "Claim Daily +20"}
                    </Button>
                  </div>
                  <div className="space-y-2">
                    <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                      {t("support_recent_transactions") ||
                        "Recent Transactions"}
                    </p>
                    {transactions.length === 0 ? (
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        {t("support_no_wallet_activity") ||
          ...
          <Card className="border-blue-100 dark:border-gray-700">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2 text-lg">
                ...
                {t("support_premium_access_title") || "Premium Access"}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-gray-600 dark:text-gray-300">
              <p>
                {t("support_premium_access_desc_1") ||
                  "Premium modules are locked by default and can be unlocked with credits from your wallet."}
              </p>
              <p>
                {t("support_premium_access_desc_2") ||
        ...
        <div className="mb-8">
          <div className="mb-3 flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">
              {t("support_premium_modules_title") || "Premium Modules"}
            </h2>
          </div>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      {unlocked ? (
                        <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100">
                          {t("support_unlocked") || "Unlocked"}
                        </Badge>
                      ) : (
                        <Badge variant="outline" className="border-blue-200">
                          {module.cost} {t("coins") || "coins"}
                        </Badge>
                      )}
                    </div>
                  ...
                  <CardContent>
                    {!loggedIn ? (
                      ...
                      >
                        ...
                        {t("support_module_unlocked_button") ||
                          "Module unlocked"}
                      </Button>
                    ) : (
                      <div className="space-y-2">
                        ...
                        {!canUnlock ? (
                          <p className="text-xs text-rose-600 dark:text-rose-400">
                            {t("support_not_enough_coins_hint") ||
        ...
        <div className="mb-8">
          <div className="mb-3 flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">
              {t("support_disease_library_title") || "Disease Library"}
            </h2>
          </div>
          ...
          {hasMoreArticles ? (
            <div className="mt-5 flex justify-center">
              ...
              >
                {t("support_load_more_articles") || "Load more articles"}
              </Button>
            </div>
          ) : null}
        </div>
        ...
        <Card className="border-blue-100 dark:border-gray-700">
          <CardHeader className="pb-3">
            <CardTitle className="text-lg">
              {t("support_legal_policies") || "Legal Policies"}
            </CardTitle>
          </CardHeader>
          <CardContent className="grid gap-2 md:grid-cols-2">
            ...
            <Link
              ...
              className="flex items-center justify-between rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
            >
              {t("support_ticket_policy") || "Support Ticket Policy"}
              <ChevronRight className="h-4 w-4" />
            </Link>
          </CardContent>
        </Card>
