  ...
  ze = () => {
    ...
    return e.createElement(
      ...
      e.createElement(
        ...
        {
          className:
            "sticky top-0 z-40 flex justify-center p-2 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md border-b transition-all active:bg-white/80",
        },
        e.createElement(
          "button",
          {
          ...
          _ && f === 1
            ...
            : e.createElement(
                e.Fragment,
                null,
                o("tap_for_new") || "Tap for new posts",
              ),
        ),
      ),
      e.createElement(
        ...
        e.createElement(
          ...
          Ce
            ? e.createElement(
                ...
                e.createElement(ie, null, "Latest refresh failed"),
                e.createElement(
                  ae,
                  null,
                  N,
            ...
            : _e
              ? e.createElement(Oe, {
                  ...
                  secondaryAction: e.createElement(
                    ...
                    o("browse_marketplace_posts") || "Browse marketplace posts",
                  ),
                })
              : n.length === 0
                ? e.createElement(je, {
                    title:
                      o("no_posts") || "No posts yet. Be the first to share!",
                    description:
                      o("feed_empty_desc") ||
                      "Share an update or browse marketplace listings while the feed is empty.",
                    icon: le,
                    marker: "empty",
                    action: h
                      ? e.createElement(
                ...
                : (h ? n : n.slice(0, Ve)).map((t) => {
                    ...
                    return e.createElement(
                      O,
                      {
                        key: r,
                        className:
                          "bg-white dark:bg-gray-800 rounded-2xl shadow-sm border overflow-hidden hover:shadow-md transition",
                      },
                      e.createElement(
                        "div",
                        {
                          className:
                            "flex items-start gap-3 px-5 pt-5 pb-3 relative",
                        },
                        e.createElement(
                          oe,
                          {
                            className:
                              "w-11 h-11 bg-gradient-to-br from-indigo-400 to-purple-500",
                          },
                          e.createElement(
                            se,
                        ...
                        e.createElement(
                          ...
                          e.createElement(
                            ...
                            e.createElement(
                              "span",
                              null,
                              t.location || o("global") || "Global",
                            ),
                            e.createElement("span", null, "\xE2\u20AC\xA2"),
                            e.createElement("span", null, Ne(t.created_at)),
                            e.createElement(
                              "span",
                              {
                                className:
                      ...
                      e.createElement(
                        "button",
                        {
                          ...
                          className:
                            "p-2 rounded-full text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700",
          ...
          !E &&
            ...
            e.createElement(
              ...
              o("end_of_feed") || "You've reached the end",
            ),
        ),
      ),
      K &&
