...
const Z = () => {
  ...
  return x
    ? e.createElement(
        ...
        {
          className:
            "min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800",
        },
        e.createElement("div", {
          className:
    ...
    : v
      ? e.createElement(
          ...
          {
            className:
              "min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900",
          },
          e.createElement(
            "div",
            {
              className:
                "sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-b border-gray-200 dark:border-gray-700",
            },
            e.createElement(
              "div",
            ...
            B &&
              e.createElement(
                ...
                {
                  className:
                    "p-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700",
                },
                e.createElement(
                  "div",
                  { className: "space-y-3" },
                      ...
                      b.map((r) =>
                        e.createElement(
                          D,
                          {
                            key: r.search_id,
                            className:
                              "bg-white dark:bg-gray-800/60 border-gray-200 dark:border-gray-700 overflow-hidden",
                          },
                          e.createElement(
                            "div",
                            { className: "p-4" },
                            e.createElement(
                              ...
                              e.createElement(
                                ...
                                e.createElement(
                                  ...
                                  {
                                    className:
                                      "text-gray-900 dark:text-white font-semibold flex items-center gap-2 cursor-pointer hover:text-purple-600 dark:hover:text-purple-400",
                                  },
                                  ...
                                  r.location &&
                                    e.createElement(
                                      C,
                                      {
                                        variant: "outline",
                                        className:
                                          "text-xs border-gray-300 text-gray-600 dark:border-gray-600 dark:text-gray-300",
                                      },
                                      e.createElement(V, {
                            ...
                            e.createElement(
                              t,
                              {
                                ...
                                onClick: () => L(r),
                                className:
                                  "mt-3 w-full border-purple-500 text-purple-400 hover:bg-purple-500/20",
                              },
          ...
          w &&
            e.createElement(
              "div",
              {
                className: `fixed bottom-24 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-lg shadow-lg z-50 ${w.type === "error" ? "bg-red-600" : "bg-green-600"} text-white text-sm`,
              },
              w.message,
            ),
        )
            ...
            e.createElement(
              ...
              e.createElement(
                t,
                {
                  ...
                  className:
                    "w-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white py-6 text-lg rounded-xl",
                },
