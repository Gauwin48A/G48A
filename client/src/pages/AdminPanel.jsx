  ...
  $e = () => {
    ...
    if (!accessChecked) {
      return e.createElement(
        ...
        {
          className:
            "min-h-screen bg-gradient-to-br from-slate-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 p-4 transition-colors duration-300",
        },
        e.createElement(
          "div",
      ...
      : e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(Ce, { className: "h-4 w-4 text-blue-700" }),
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                {
                  className:
                    "bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-700 dark:to-blue-900 text-white shadow-lg border-0",
                },
                e.createElement(
                  g,
                  { className: "p-4" },
                  e.createElement(
                    ...
                    e.createElement(Ae, { className: "w-8 h-8 text-blue-200" }),
                  ),
                ),
              ),
              e.createElement(
                ...
                {
                  className:
                    "bg-gradient-to-r from-green-500 to-green-600 dark:from-green-700 dark:to-green-900 text-white shadow-lg border-0",
                },
                e.createElement(
                  g,
                  { className: "p-4" },
              ...
              e.createElement(
                ...
                {
                  className:
                    "bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-700 dark:to-orange-900 text-white shadow-lg border-0",
                },
                e.createElement(
                  g,
                  { className: "p-4" },
              ...
              e.createElement(
                ...
                {
                  className:
                    "bg-gradient-to-r from-red-500 to-red-600 dark:from-red-700 dark:to-red-900 text-white shadow-lg border-0",
                },
                e.createElement(
                  g,
                  { className: "p-4" },
                  e.createElement(
                    ...
                    e.createElement(de, { className: "w-8 h-8 text-red-200" }),
                  ),
                ),
              ),
            ),
            e.createElement(
              ...
              e.createElement(
                ...
                {
                  className:
                    "grid w-full grid-cols-4 h-12 bg-white dark:bg-gray-800",
                },
                e.createElement(
                  I,
                  {
              ...
              e.createElement(
                ...
                e.createElement(
                  o,
                  { className: "shadow-lg bg-white dark:bg-gray-800 border-0" },
                  e.createElement(
                    _,
                    null,
                    e.createElement(
                      ...
                      {
                        className:
                          "flex items-center justify-between text-gray-900 dark:text-white flex-wrap gap-2",
                      },
                      e.createElement(
                        "span",
                        null,
                          ...
                          se.map((t) => {
                            ...
                            return e.createElement(
                              o,
                              {
                                key: t.id,
                                className:
                                  "border-l-4 border-l-red-500 bg-white dark:bg-gray-700 dark:border-gray-600",
                              },
                              e.createElement(
                                g,
                                { className: "p-4" },
                                e.createElement(
                                  ...
                                  e.createElement(
                                    ...
                                    e.createElement(
                                      ...
                                      e.createElement(
                                        V,
                                        {
                                          variant: "outline",
                                          className:
                                            "text-red-600 dark:text-red-400 dark:border-red-400",
                                        },
                                    ...
                                    e.createElement(
                                      ...
                                      {
                                        className:
                                          "space-y-1 text-sm text-gray-600 dark:text-gray-300",
                                      },
                                      e.createElement(
                                        "p",
                                        null,
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      ...
                      {
                        className:
                          "text-gray-900 dark:text-white flex items-center justify-between gap-2 flex-wrap",
                      },
                          ...
                          re.map((t) =>
                            e.createElement(
                              o,
                              {
                                key: t.id,
                                className:
                                  "border-l-4 border-l-orange-500 bg-white dark:bg-gray-700 dark:border-gray-600",
                              },
                              e.createElement(
                                g,
                                { className: "p-4" },
                      ...
                      e.createElement(
                        ...
                        e.createElement(
                          ...
                          e.createElement(
                            ...
                            {
                              className:
                                "font-semibold mb-2 text-yellow-800 dark:text-yellow-100",
                            },
                          ...
                          e.createElement(
                            ...
                            {
                              className:
                                "list-disc list-inside text-sm space-y-1 text-gray-700 dark:text-gray-300",
                            },
                            e.createElement(
                              "li",
                              null,
                      ...
                      e.createElement(
                        ...
                        e.createElement(
                          ...
                          e.createElement(
                            ...
                            {
                              className:
                                "font-semibold mb-2 text-red-800 dark:text-red-100",
                            },
                      ...
                      : e.createElement(
                          ...
                          K.map((t, r) => {
                            ...
                            return e.createElement(
                              ...
                              {
                                key: `${t.action}-${r}`,
                                className: `flex items-center justify-between p-3 rounded-lg border-l-4 ${i}`,
                              },
                              e.createElement(
                                "div",
                                { className: "flex-1" },
