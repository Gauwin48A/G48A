...
const tierPlans = [
  {
    ...
    features: [
      ...
      { key: "visibility_30_days_basic", label: "30 days visibility", included: true },
  ...
  },
  {
    ...
    ctaLabel: "Get Bronze",
    features: [
      { key: "post_limit_bronze", label: "1 post per day limit", included: true },
      { key: "image_limit_bronze", label: "Max 1 image per post", included: true },
      ...
      { key: "std_boosting_bronze", label: "Standard Boosting Costs (200c Boost / 300c Featured / 500c Spotlight)", included: true },
    ],
  },
  {
    key: "silver",
    ...
    ctaLabel: "Get Silver",
    features: [
      { key: "post_limit_silver", label: "1 post per day limit", included: true },
      { key: "image_limit_silver", label: "Max 1 image per post", included: true },
      { key: "visibility_30_days", label: "30 days visibility per listing", included: true },
      ...
      { key: "coin_mult_1x_silver", label: "Standard Coin Rate (100 coins = ₹1.00)", included: true },
      { key: "std_boosting_silver", label: "Standard Boosting Costs (200c Boost / 300c Featured / 500c Spotlight)", included: true },
    ],
  },
  {
    key: "gold",
    nameKey: "gold_seller",
    nameFallback: "Gold Seller",
    subtitleKey: "gold_subtitle",
    subtitleFallback: "Extended 9-month growth",
    price: "₹1,500",
    periodKey: "per_9_months",
    periodFallback: "per 9 months",
    perPostCost: "1 post/day",
    icon: Award,
    cardBg: "mhub-premium-surface border border-emerald-200/60 dark:border-emerald-500/20",
    iconBg: "bg-gradient-to-br from-emerald-100 to-green-200 dark:from-emerald-800/30 dark:to-green-700/20 shadow-sm shadow-emerald-200/50",
    iconColor: "text-emerald-700 dark:text-emerald-300",
    priceColor: "text-slate-900 dark:text-white",
    accentColor: "text-emerald-700 dark:text-emerald-300",
    buttonClass: "bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white font-semibold shadow-md shadow-emerald-500/25 hover:shadow-lg hover:shadow-emerald-500/30",
    trialButtonClass: "",
    ctaLabel: "Get Gold",
    features: [
      { key: "post_limit_gold", label: "1 post per day limit", included: true },
      { key: "image_limit_gold", label: "Max 1 image per post", included: true },
      { key: "visibility_30_days_gold", label: "30 days visibility per listing", included: true },
      { key: "boosts_featured_gold", label: "5 boosts + 5 featured + 5 spotlights / 9 months", included: true },
      { key: "verified_badge_gold", label: "Verified seller badge", included: true },
      { key: "priority_search_gold", label: "Priority search ranking", included: true },
      { key: "full_analytics_gold", label: "Full analytics dashboard", included: true },
      { key: "coin_mult_1x_gold", label: "Standard Coin Rate (100 coins = ₹1.00)", included: true },
      { key: "std_boosting_gold", label: "Standard Boosting Costs (200c Boost / 300c Featured / 500c Spotlight)", included: true },
    ],
  },
  {
    key: "premium",
    ...
    ctaLabel: "Go Premium",
    features: [
      { key: "post_limit_premium", label: "Max 2 posts per day limit", included: true },
      { key: "image_limit_premium", label: "Max 10 images per post", included: true },
      { key: "visibility_45_days", label: "45 days visibility per listing", included: true },
      { key: "boosts_featured_spotlight", label: "5 boosts + 5 featured + 5 spotlights / month", included: true },
      { key: "coin_mult_5x", label: "🔥 5x Coin Valuation Multiplier (100 coins = ₹5.00)", included: true },
      { key: "cheap_boosting", label: "Lowest Boosting Costs (50c Boost / 100c Featured / 200c Spotlight)", included: true },
      { key: "coin_plan_discount_25", label: "Claim 25% off plan using 7,200 coins (₹450 off ₹1,800 plan)", included: true },
