...
import { getAllChannels as I, followChannel as A } from "../lib/api";
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement("div", {
                        className:
                          "h-4 w-40 rounded bg-gray-200 dark:bg-gray-700",
                      }),
                      e.createElement("div", {
                        className:
                          "h-3 w-56 rounded bg-gray-200 dark:bg-gray-700",
                      }),
                    ),
                  ),
                  e.createElement("div", {
                    className: "h-9 w-24 rounded bg-gray-200 dark:bg-gray-700",
                  }),
                ),
              ),
            ),
          ...
          : N.length === 0
            ? e.createElement(q, {
                ...
                message: s
                  ...
                  : r("be_first_create_channel") ||
                    "Be the first to create a channel.",
                actionLabel: s ? "" : r("create_channel") || "Create Channel",
                onAction: s ? null : () => _("/channels/create"),
              })
            : e.createElement(
                "ul",
                { className: "space-y-3" },
                        ...
                        e.createElement(
                          ...
                          e.createElement(
                            C,
                            {
                              to: `/channels/${t}`,
                              className:
                                "rounded-md border border-blue-200 px-3 py-2 text-sm font-medium text-blue-700 hover:bg-blue-50 dark:border-blue-700 dark:text-blue-300",
                            },
                            r("view") || "View",
                          ),
                        ),
