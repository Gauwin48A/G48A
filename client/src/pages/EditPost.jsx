...
const EditPost = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen mhub-premium-page bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900/60 dark:to-slate-950 flex items-center justify-center p-6 text-gray-600 dark:text-gray-300 dark:bg-gradient-to-br dark:text-gray-200">
