...
import { getApiOriginBase as ne } from "@/lib/networkConfig";
const me = () => {
  const { t } = de(),
  ...
  const U = () => {
    ...
    E = async (r) => {
      ...
      try {
        ...
        const l = await fetch(`${B}/api/feedback`, {
            method: "POST",
            headers: {
        ...
        if (!l.ok)
          throw new Error(
            s.error ||
              s.message ||
              tr("feedback_submit_failed", "Failed to submit feedback"),
          );
        const x = q(s);
      ...
      [...Array(5)].map((r, a) =>
        e.createElement(
          "button",
          {
            ...
            type: "button",
            onClick: () => z(a + 1),
            className: `text-2xl transition-all transform hover:scale-125 ${a < o.rating ? "text-yellow-400" : "text-gray-300"} hover:text-yellow-400`,
          },
  ...
  return w
    ? e.createElement(
        ...
        {
          className:
            "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900 relative",
        ...
        e.createElement(
          ...
          e.createElement("div", {
            className:
              "absolute top-20 left-10 w-72 h-72 bg-blue-500/10 dark:bg-blue-500/20 rounded-full blur-3xl animate-pulse",
          }),
          e.createElement("div", {
            className:
              "absolute bottom-20 right-10 w-96 h-96 bg-purple-500/10 dark:bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000",
          }),
          e.createElement("div", {
            className:
              "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-500/5 dark:bg-indigo-500/10 rounded-full blur-3xl",
          }),
        ),
        e.createElement(
          "div",
          ...
          e.createElement(
            ...
            e.createElement(
              "button",
              {
                onClick: () => c("/"),
                className:
                  "inline-flex items-center text-blue-600 dark:text-blue-300 hover:text-blue-700 dark:hover:text-blue-200 mb-8 group transition-all",
              },
              e.createElement(X, {
                className:
            ...
            e.createElement(
              ...
              {
                className:
                  "inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-400 to-indigo-600 shadow-2xl shadow-blue-500/30 mb-6",
              },
              e.createElement(g, { className: "w-10 h-10 text-white" }),
            ),
            e.createElement(
              "h1",
              {
            ...
            e.createElement(
              ...
              {
                className:
                  "text-blue-700 dark:text-blue-200 text-lg max-w-md mx-auto",
              },
              t("help_us_improve"),
            ),
          ),
          e.createElement(
            ...
            e.createElement(
              ...
              {
                className:
                  "bg-blue-500/10 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border-blue-500/20 dark:border-blue-500/30 px-4 py-2 rounded-full backdrop-blur-sm",
              },
            ...
            e.createElement(
              ...
              {
                className:
                  "bg-purple-500/10 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 border-purple-500/20 dark:border-purple-500/30 px-4 py-2 rounded-full backdrop-blur-sm",
              },
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              {
                className:
                  "bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white p-8",
              },
              e.createElement(
                G,
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    {
                      className:
                        "text-sm font-bold text-gray-700 dark:text-gray-200 mb-3 block",
                    },
                    t("feedback_category"),
                  ),
                  e.createElement(
                    ...
                    M.map((r) =>
                      e.createElement(
                        "button",
                        {
                          ...
                          className: `p-4 rounded-xl border-2 transition-all text-left ${o.feedbackType === r.value ? "border-blue-500 bg-blue-50 dark:bg-blue-900/30 shadow-lg" : "border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700/50"}`,
                        },
                        e.createElement(
                          "div",
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    {
                      className:
                        "flex items-center gap-2 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl",
                    },
                    e.createElement(
                      "div",
                    ...
                    e.createElement(
                      ...
                      {
                        className:
                          "ml-4 text-lg font-semibold text-gray-700 dark:text-gray-200",
                      },
                      o.rating,
                      " / 5",
                    ),
                ...
                e.createElement(
                  ...
                  e.createElement(W, {
                    ...
                    className:
                      "h-14 text-lg rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-blue-500 transition-colors",
                    required: !0,
                  }),
                ),
                e.createElement(
                  ...
                  e.createElement(K, {
                    ...
                    rows: 6,
                    className:
                      "text-lg rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-blue-500 transition-colors resize-none",
                    required: !0,
                  }),
                ),
                e.createElement(
                  f,
                  {
                    ...
                    disabled: N,
                    className:
                      "w-full h-16 text-lg font-bold bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 rounded-2xl shadow-xl shadow-blue-500/30 transition-all hover:shadow-blue-500/50 hover:scale-[1.02]",
                  },
                  N
                    ? e.createElement(
                        "span",
          ...
          e.createElement(
            ...
            {
              className:
                "shadow-2xl border-0 rounded-3xl overflow-hidden backdrop-blur-xl bg-gradient-to-r from-blue-500 to-indigo-600",
            },
            e.createElement(
              m,
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  {
                    className:
                      "w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center",
                  },
          ...
          e.createElement(
            ...
            {
              className:
                "shadow-2xl border-0 rounded-3xl overflow-hidden backdrop-blur-xl bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 border-2 border-green-200 dark:border-green-700",
            },
            e.createElement(
              m,
              { className: "p-6" },
              e.createElement(
                ...
                e.createElement(
                  ...
                  {
                    className:
                      "w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0",
                  },
                  e.createElement(T, { className: "w-6 h-6 text-green-600" }),
                ),
                e.createElement(
                  "div",
                  null,
                  e.createElement(
                    ...
                    {
                      className:
                        "font-bold text-green-800 dark:text-green-300 text-lg mb-2",
                    },
                    "\uD83D\uDCE7 ",
                    t("direct_contact"),
                  ),
                  e.createElement(
                    "div",
                    {
                      className: "space-y-1 text-green-700 dark:text-green-400",
                    },
                    e.createElement(
                      "p",
                      null,
          ...
          e.createElement(
            ...
            {
              className:
                "shadow-2xl border-0 rounded-3xl overflow-hidden backdrop-blur-xl bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 border-2 border-purple-200 dark:border-purple-700",
            },
            e.createElement(
              m,
              ...
              e.createElement(
                ...
                {
                  className:
                    "text-2xl font-bold text-purple-800 dark:text-purple-300 mb-2",
                },
              ...
              e.createElement(
                ...
                {
                  className:
                    "text-purple-700 dark:text-purple-400 max-w-md mx-auto",
                },
        ...
        A &&
          e.createElement(
            "button",
            {
              onClick: U,
              className:
                "fixed bottom-24 right-6 w-14 h-14 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full shadow-2xl shadow-blue-500/40 flex items-center justify-center hover:scale-110 transition-all z-50 animate-bounce",
            },
    ...
    : e.createElement(
        ...
        e.createElement(
          ...
          e.createElement(
            ...
            {
              className:
                "w-24 h-24 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center shadow-2xl",
            },
            e.createElement(g, { className: "w-12 h-12 text-white" }),
          ),
          e.createElement(
            "h1",
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(oe, { className: "w-7 h-7 text-white" }),
              ),
              e.createElement(
                "div",
                { className: "flex-1" },
              ...
              e.createElement(L, { className: "w-6 h-6 text-gray-400" }),
            ),
          ),
          e.createElement(
            I,
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(j, { className: "w-7 h-7 text-white" }),
              ),
              e.createElement(
                "div",
                { className: "flex-1" },
              ...
              e.createElement(L, { className: "w-6 h-6 text-white/60" }),
            ),
          ),
        ),
      );
