  ...
  ve = () => {
      ...
      b = R(async () => {
        ...
        try {
          const [s, d, o] = await Promise.all([
            _.get("/api/analytics/seller"),
            _.get("/api/analytics/posts"),
            _.get("/api/analytics/categories"),
          ]);
          ...
          const k = s?.data ?? s,
            ...
            j = o?.data ?? o;
          N(k?.overview || null),
            Y(Array.isArray(E?.posts) ? E.posts : []),
            J(Array.isArray(j?.breakdown) ? j.breakdown : []),
            q("");
        } catch (s) {
          t === l.current && q(ue(s)),
            import.meta.env.DEV &&
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(t, { className: "w-6 h-6 text-white" }),
              ),
              typeof o == "number"
                ? e.createElement(
                    B,
            ...
            e.createElement(
              ...
              {
                className:
                  "text-3xl font-bold mt-4 text-gray-900 dark:text-white",
              },
              d,
            ),
            e.createElement(
    ...
    return e.createElement(
      ...
      e.createElement(
        ...
        {
          className:
            "bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 px-4 py-8",
        },
        e.createElement(
          "div",
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                {
                  className:
                    "text-3xl font-bold text-white flex items-center gap-3 flex-wrap",
                },
              ...
              e.createElement(
                "p",
                { className: "text-blue-100 mt-1 break-words" },
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(y, { to: "/add-post" }, "Add Post"),
              ),
            ),
          ),
          e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(K, { className: "w-5 h-5 text-blue-600" }),
                ...
                ? e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(
                        n,
                        { asChild: !0 },
                        e.createElement(y, { to: "/add-post" }, "Add New Post"),
                      ),
                    ),
                  )
                : e.createElement(
                    ...
                    Q.map((t) =>
                      e.createElement(
                        "div",
                        {
                          key: t.post_id,
                          className:
                            "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl",
                        },
                        e.createElement(
                          "div",
                          { className: "flex-1" },
                          ...
                          e.createElement(
                            ...
                            {
                              className:
                                "flex flex-wrap items-center gap-3 mt-1 text-sm text-gray-500",
                            },
        ...
        e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(
              M,
              { className: "flex items-center gap-2" },
              e.createElement(F, { className: "w-5 h-5 text-purple-600" }),
              "Category Breakdown (",
              C,
              ")",
            ),
                  ...
                  z.map((t, s) =>
                    e.createElement(
                      "div",
                      {
                        key: `${t.category}-${s}`,
                        className:
                          "flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl",
                      },
                      e.createElement(
                        "div",
                        null,
