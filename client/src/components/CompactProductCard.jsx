...
const CompactProductCard = memo(function CompactProductCard({
  ...
  return (
    <article
      className="flex bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-2 shadow-sm hover:shadow-md transition-shadow cursor-pointer"
