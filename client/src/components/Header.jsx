  ...
  return (
    <header className="sticky top-0 z-30 w-full bg-blue-600 shadow-md flex items-center px-4 py-2">
      <div className="flex items-center gap-2">
        <img src="/vite.svg" alt={t('logo_alt')} className="h-8 w-8" />
        <span className="text-white font-bold text-xl ml-2">{t('shop')}</span>
      </div>
      ...
      <div className="flex items-center gap-4 ml-4">
        <button className="flex items-center gap-1 bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 px-3 py-1 rounded-full shadow hover:bg-blue-50 dark:hover:bg-slate-700">
