...
export default function NotificationPermission({ userId, onDismiss }) {
  ...
  useEffect(() => {
    ...
    return (
        <div className="fixed bottom-[calc(var(--bottom-nav-height,64px)+env(safe-area-inset-bottom,0px)+1rem)] left-4 right-4 md:left-auto md:right-4 md:w-96 z-[60] animate-slide-up">
