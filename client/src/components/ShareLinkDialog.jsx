  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl p-0 overflow-hidden">
        <DialogHeader className="px-6 py-5 bg-gradient-to-r from-blue-50/80 via-indigo-50/70 to-cyan-50/80 dark:from-slate-900/80 dark:via-slate-900/80 dark:to-slate-800/70 border-b border-[var(--chip-border)]">
          <DialogTitle className="flex items-center gap-2 text-[var(--text-strong)]">
        ...
        <div className="px-6 py-5 space-y-5">
          <div className="rounded-2xl border border-[var(--chip-border)] bg-[var(--surface-2)] p-4 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            <Button
              type="button"
              variant="outline"
              className="h-11 justify-start border-[var(--chip-border)]"
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <Button
              ...
              disabled={!safeUrl}
              className="h-11 border-[var(--chip-border)]"
            >
