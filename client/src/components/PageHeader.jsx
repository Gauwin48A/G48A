import e from"react";import{useNavigate as m}from"react-router-dom";import{ArrowLeft as n}from"lucide-react";import{Button as b}from"@/components/ui/button";const x=({title:a,showBack:s=!0,backTo:r,rightAction:l,className:i="",transparent:t=!1})=>{const o=m(),d=()=>{o(r||-1)};return e.createElement("div",{className:`
      ...
      ${i}
    `},e.createElement("div",{className:"mx-auto flex w-full max-w-6xl items-center gap-3 px-4 py-3"},e.createElement("div",{className:"flex items-center gap-3 min-w-0 flex-1"},s&&e.createElement(b,{onClick:d,variant:"ghost",size:"icon",className:`
          ...
          `},a)),l&&e.createElement("div",{className:"ml-auto flex items-center gap-2 flex-shrink-0"},l)))};var u=x;export{u as default};
