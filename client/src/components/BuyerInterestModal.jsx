...
function BuyerInterestModal({ isOpen, onClose, postId, postTitle }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="w-[95%] max-w-md mhub-premium-surface border-0 shadow-2xl rounded-2xl mx-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600 dark:text-gray-400">
            ...
            {t("interest_description") ||
              "Share your contact details with the seller. They will reach out to you."}
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="mhub-input w-full px-4 py-3 rounded-xl text-[var(--text)] focus:ring-2 focus:ring-ring focus:ring-offset-0 transition"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder={
                  t("enter_message") ||
                  "Any questions for the seller? E.g., Is price negotiable?"
                }
                rows={3}
                className="mhub-input w-full px-4 py-3 rounded-xl text-[var(--text)] focus:ring-2 focus:ring-ring focus:ring-offset-0 transition resize-none"
              />
            </div>
            ...
            <p className="text-xs text-center text-gray-500 dark:text-gray-400 mt-2">
              {"\uD83D\uDD12"}{" "}
              {t("privacy_note") ||
                "Your details will only be shared with this seller."}
            </p>
          </form>
        )}
      </DialogContent>
