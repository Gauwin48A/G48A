...
describe("MyRecommendations smoke", () => {
  beforeEach(() => {
    ...
    hoisted.categoryMode = {
      ...
      categories: [
        ...
        { category_id: "2", name: "Vehicles", category_group: "vehicles" },
      ],
      hasSelection: false,
      loading: false,
      selectCategory: vi.fn(),
  ...
  it("filters mixed recommendations down to the active app", async () => {
    hoisted.categoryMode = {
      ...hoisted.categoryMode,
      activeApp: "vehicles",
    };
    ...
    expect(await screen.findByText("Vehicle recommendation")).toBeTruthy();
    expect(screen.queryByText("Fashion recommendation")).toBeNull();
  });
});
