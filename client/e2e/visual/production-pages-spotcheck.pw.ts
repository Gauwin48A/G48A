...
const OUTPUT_DIR = path.resolve(process.cwd(), '..', 'analysis', 'production-audit');
...
test.describe('Production Pages Sweep', () => {
  ...
  test('capture production audit pages', async ({ page, baseURL }) => {
    ...
    for (const route of routes) {
      ...
      console.log(`[production-audit] Saved ${name}.png`);
    }
  });
});
