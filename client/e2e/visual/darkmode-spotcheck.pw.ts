...
const OUTPUT_DIR = path.resolve(process.cwd(), '..', 'analysis', 'darkmode-audit');
...
test.describe('Dark Mode Spotcheck', () => {
  ...
  test('capture key pages in dark mode', async ({ page, baseURL }) => {
    ...
    for (const route of routes) {
      ...
      console.log(`[darkmode-audit] Saved ${name}.png`);
    }
  });
});
