...
| Multi-region active-active orchestration command set | COMPLETE | `server/scripts/run_active_active_orchestration.js`, `server/scripts/run_active_active_dependency_gate.js`, `server/tests/runActiveActiveOrchestration.test.js`, `server/tests/activeActiveDependencyGate.test.js`, `server/docs/artifacts/active_active_orchestration_2026-02-28T04-34-16-803Z.json`, `server/docs/artifacts/active_active_dependency_gate_2026-02-28T05-18-03-656Z.json` | synthetic execute command with traffic template + `npm run failover:active-active:dependency-gate` |
