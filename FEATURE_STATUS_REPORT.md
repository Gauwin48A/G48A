...
| Authenticated read/write load coverage | COMPLETE | `server/src/controllers/authController.js`, `server/src/middleware/security.js`, `server/tests/authenticateToken.cache.test.js`, `server/tests/load/results/capacity_report_2026-02-28T06-08-26-697Z.json` | `node tests/load/simple_load_runner.js --scenario full` |
