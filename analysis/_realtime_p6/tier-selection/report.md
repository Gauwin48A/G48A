...
- **Scroll height:** 2966px (NaN screens)
- **Score:** **10/10**
...
### Screenshots
- Full page: `tier-selection-full.png`
- `tier-selection-scroll00.png`
- `tier-selection-scroll01.png`
- `tier-selection-scroll02.png`
- `tier-selection-scroll03.png`
- `tier-selection-scroll04.png`