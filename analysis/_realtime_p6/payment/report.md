...
- **Scroll height:** 1480px (NaN screens)
- **Score:** **9.8/10**
...
- `<button>` 22×36 — "" — `rounded-lg p-1 text-slate-400`
- `<span>` 24×36 — "" — `rounded-lg p-1 text-slate-400`
...
### Screenshots
- Full page: `payment-full.png`
- `payment-scroll00.png`
- `payment-scroll01.png`
- `payment-scroll02.png`