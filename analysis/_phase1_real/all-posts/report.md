...
- **Scroll height:** 2873px (NaN screens)
- **Score:** **8/10**
...
- `<span>` 11px — "All Posts" — `mhub-bottom-nav-label is-active`
...
- `<button>` 95×35 — "9" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "34" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "48" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "65" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "" — `shrink-0 inline-flex h-11`
- `<button>` 95×35 — "" — `shrink-0 inline-flex h-11`
...
- **log**: [LocationGate] Device info sent: fp_o88yng

### Screenshots
- Full page: `all-posts-full.png`
- `all-posts-scroll00.png`
- `all-posts-scroll01.png`
- `all-posts-scroll02.png`
- `all-posts-scroll03.png`
- `all-posts-scroll04.png`