# Audit — aadhaar-verify

- **Route:** `/aadhaar-verify`
- **Logged in:** true
- **Viewport:** undefined×undefined
- **Scroll height:** 1466px (NaN screens)
- **Score:** **10/10**
...
### Screenshots
- Full page: `aadhaar-verify-full.png`
- `aadhaar-verify-scroll00.png`
- `aadhaar-verify-scroll01.png`
- `aadhaar-verify-scroll02.png`