# Audit — support-ticket-policy

- **Route:** `/support-ticket-policy`
- **Logged in:** false
- **Viewport:** undefined×undefined
- **Scroll height:** 1657px (NaN screens)
- **Score:** **10/10**
...
- **log**: [MHub:Interceptor] START /cms/pages/support-ticket-policy

### Screenshots
- Full page: `support-ticket-policy-full.png`
- `support-ticket-policy-scroll00.png`
- `support-ticket-policy-scroll01.png`
- `support-ticket-policy-scroll02.png`